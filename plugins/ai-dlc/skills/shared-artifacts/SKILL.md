...
AI-DLC ワークフローで作成される全成果物について、**書き方ガイド（references/）とテンプレート（templates/）**を集約する。
...
| - | ------------------------------ | ----------------------- | -------------------------------------- | ------------------------------------------ | ----------------------------------------- |
| 1 | `progress.yaml`                | 全サイクル             | (Main が維持)                          | `references/progress-yaml.md`              | `templates/progress.yaml`                 |
| 2 | `intent-spec.md`               | Inception Step 1        | `intent-analyst`                       | `references/intent-spec.md`                | `templates/intent-spec.md`                |
| 3 | `research/<topic>.md`          | Inception Step 2        | `researcher` (観点ごと並列)            | `references/research-note.md`              | `templates/research-note.md`              |
| 4 | `design.md`                    | Inception Step 3        | `architect`                            | `references/design.md`                     | `templates/design.md`                     |
| 5 | `task-plan.md`                 | Inception Step 4        | `planner`                              | `references/task-plan.md`                  | `templates/task-plan.md`                  |
| 6 | `TODO.md`                      | Construction 全体       | (Main が維持、`task-plan.md` から生成) | `references/todo.md`                       | `templates/TODO.md`                       |
| 7 | `implementation-logs/<id>.md`  | Construction Step 5     | `implementer` (タスクごと並列)         | `references/implementation-log.md`         | `templates/implementation-log.md`         |
| 8 | `self-review-report.md`        | Construction Step 6     | `self-reviewer`                        | `references/self-review-report.md`         | `templates/self-review-report.md`         |
| 9 | `review/<aspect>.md`           | Verification Step 7     | `reviewer` (観点ごと並列)              | `references/review-report.md`              | `templates/review-report.md`              |
|10 | `validation-report.md`         | Verification Step 8     | `validator`                            | `references/validation-report.md`          | `templates/validation-report.md`          |
|11 | `retrospective.md`             | Verification Step 9     | `retrospective-writer`                 | `references/retrospective.md`              | `templates/retrospective.md`              |
...
1. 対応する `references/<name>.md` を読み、書き方を理解する
2. `templates/<name>.md` をコピーして `docs/ai-dlc/<identifier>/<artifact>.md` に配置
3. プレースホルダを埋める（references の指針に従う）
4. 完成したら Main に返却

### Main が成果物をレビューするとき

1. 対応する `references/<name>.md` の品質基準を参照
...
各ファイルの詳細な書き方は `references/<name>.md` を参照。
...
- **起票条件:** サイクル内で発生した判断が**プロジェクト全体に及ぶ**場合のみ（詳細は `references/design.md` の「ADR 起票の判定基準」参照）
...
2. Specialist が `templates/<name>.md` をコピーして `docs/ai-dlc/<identifier>/<artifact>.md` に配置
3. `references/<name>.md` の指針に従ってプレースホルダを全て埋める
4. Specialist が Main に成果物パス + 要約を返却
5. Main が `references/<name>.md` の品質基準で成果物をレビュー
