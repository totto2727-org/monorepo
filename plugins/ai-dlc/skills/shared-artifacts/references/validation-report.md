...
- **作成ステップ:** Verification Step 8 (Validation)
- **承認:** ユーザー承認必須
...
大きな証拠データは `docs/ai-dlc/<identifier>/validation-evidence/` 配下に保存してリンク。
...
- **出力先:** 成功基準未達 → ロールバック先決定（実装バグ: Step 5 / 設計ミス: Step 3 / 基準不適切: Step 1）
