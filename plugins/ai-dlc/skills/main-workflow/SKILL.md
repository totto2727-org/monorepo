...
**詳細スキル:** `main-construction` — 以下 2 ステップ 5. Implementation — 実装 6. Self-Review — 自己レビュー
...
**詳細スキル:** `main-verification` — 以下 3 ステップ 7. External Review — 外部レビュー 8. Validation — 検証 9. Retrospective — 振り返り
