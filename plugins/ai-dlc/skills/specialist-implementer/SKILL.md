...
description: >
  [Specialist 用] AI-DLC Construction Step 5 (Implementation) を担当する専門エージェント
...
| 項目           | 内容                                                             |
| -------------- | ---------------------------------------------------------------- |
| 担当ステップ   | Construction Step 5 (Implementation)                             |
...
7. 動作確認結果を Main に報告:
   - 通常は 1–3 行の要約で十分
   - ログが長大な場合は `docs/ai-dlc/<identifier>/implementation-logs/<task-id>.md` に保存（テンプレートに従う）
