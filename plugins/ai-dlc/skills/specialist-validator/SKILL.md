...
description: >
  [Specialist 用] AI-DLC Verification Step 8 (Validation) を担当する専門エージェント validator
...
| 項目         | 内容                                               |
| ------------ | -------------------------------------------------- |
| 担当ステップ | Verification Step 8 (Validation)                   |
| 成果物       | `docs/ai-dlc/<identifier>/validation-report.md`    |
...
4. 証拠保存:
   ...
   - 大きな証跡は `docs/ai-dlc/<identifier>/validation-evidence/` 配下に保存してリンク
