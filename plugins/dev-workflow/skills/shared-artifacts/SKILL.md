...
| 11  | `review/<aspect>.md`          | Step 7         | `reviewer` (観点ごと並列)              | `shared-artifacts/references/review-report.md`      | `shared-artifacts/templates/review-report.md`      |
| 12  | `validation-report.md`        | Step 7         | `validator`                            | `shared-artifacts/references/validation-report.md`  | `shared-artifacts/templates/validation-report.md`  |
| 13  | `retrospective.md`            | Step 7        | `retrospective-writer`                 | `shared-artifacts/references/retrospective.md`      | `shared-artifacts/templates/retrospective.md`      |
...
│   ├── performance.md
│   └── ...
├── validation-report.md       # Step 7 成果物
├── validation-evidence/       # Step 7 の大きな証跡（必要な場合のみ）
│   └── <evidence-file>
└── retrospective.md           # Step 7 成果物
```
