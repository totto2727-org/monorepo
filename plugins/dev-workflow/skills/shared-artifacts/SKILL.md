...
| 5   | `task-plan.md`                | Step 4         | `planner`                              | `shared-artifacts/references/task-plan.md`          | `shared-artifacts/templates/task-plan.md`          |
| 6   | `TODO.md`                     | Step 5〜6 全体 | (Main が維持、`task-plan.md` から生成) | `shared-artifacts/references/todo.md`               | `shared-artifacts/templates/TODO.md`               |
| 7   | `implementation-logs/<id>.md` | Step 5         | `implementer` (タスクごと並列)         | `shared-artifacts/references/implementation-log.md` | `shared-artifacts/templates/implementation-log.md` |
| 8   | `self-review-report.md`       | Step 6         | `self-reviewer`                        | `shared-artifacts/references/self-review-report.md` | `shared-artifacts/templates/self-review-report.md` |
| 9   | `review/<aspect>.md`          | Step 7         | `reviewer` (観点ごと並列)              | `shared-artifacts/references/review-report.md`      | `shared-artifacts/templates/review-report.md`      |
| 10  | `validation-report.md`        | Step 7         | `validator`                            | `shared-artifacts/references/validation-report.md`  | `shared-artifacts/templates/validation-report.md`  |
| 11  | `retrospective.md`            | Step 8         | `retrospective-writer`                 | `shared-artifacts/references/retrospective.md`      | `shared-artifacts/templates/retrospective.md`      |
...
├── TODO.md                    # Step 5 進行中のタスク状態（Main が維持）
...
- ワークフロー手順（ステップの進め方・コミット規約・再開プロトコル） → `dev-workflow` / `dev-workflow` / `dev-workflow` / `dev-workflow`
...
- 「Step 1〜4 (Intent Clarification 〜 Task Decomposition)を開始して」 → `dev-workflow`
