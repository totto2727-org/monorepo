...
| 10  | `validation-report.md`        | Step 8         | `validator`                            | `shared-artifacts/references/validation-report.md`  | `shared-artifacts/templates/validation-report.md`  |
| 11  | `retrospective.md`            | Step 9         | `retrospective-writer`                 | `shared-artifacts/references/retrospective.md`      | `shared-artifacts/templates/retrospective.md`      |
