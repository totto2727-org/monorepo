...
description: >
  [Specialist 用] dev-workflow Step 1 (Intent Clarification) を担当する専門エージェント
...
| テンプレート | `share-artifacts/templates/intent-spec.md`  |
| 書き方ガイド | `share-artifacts/references/intent-spec.md` |
