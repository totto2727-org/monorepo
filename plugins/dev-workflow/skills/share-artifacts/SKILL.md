...
| #   | Artifact                                       | Phase / Step          | Author (Specialist)                       | Reference                                              | Template                                              |
| --- | ---------------------------------------------- | --------------------- | ----------------------------------------- | ------------------------------------------------------ | ----------------------------------------------------- |
| 1   | `progress.yaml`                                | All cycles            | (maintained by Main)                      | `share-artifacts/references/progress-yaml.md`         | `share-artifacts/templates/progress.yaml`            |
...
| 3   | `research/<topic>.md`                          | Step 2                | `researcher` (parallel per aspect)         | `share-artifacts/references/research-note.md`         | `share-artifacts/templates/research-note.md`         |
...
| 8   | `TODO.md`                                      | Throughout Steps 6-7  | (maintained by Main, generated from `task-plan.md`) | `share-artifacts/references/todo.md`                  | `share-artifacts/templates/TODO.md`                  |
| 9   | `implementation-logs/<id>.md`                  | Step 6                | `implementer` (parallel per task)          | `share-artifacts/references/implementation-log.md`    | `share-artifacts/templates/implementation-log.md`    |
| 10  | `review/<aspect>.md`                           | Step 7                | `reviewer` (6 aspects in parallel)         | `share-artifacts/references/review-report.md`         | `share-artifacts/templates/review-report.md`         |
...
| 12  | `docs/retrospective/<id>.md`                   | Step 9 (aggregated)   | `retrospective-writer`                    | `share-artifacts/references/retrospective.md`         | `share-artifacts/templates/retrospective.md`         |
...
| 15  | `roadmap-progress.yaml`                        | dev-roadmap Steps 1-4 | (autonomously updated by Main / dev-workflow) | `share-artifacts/references/roadmap-progress-yaml.md` | `share-artifacts/templates/roadmap-progress.yaml`    |
...
| 17  | PR description (persisted only on GitHub)      | All cycles (each Step)| (sent by Main via `gh pr edit`)            | `share-artifacts/references/pr-body.md`               | `share-artifacts/templates/pr-body.md`               |
