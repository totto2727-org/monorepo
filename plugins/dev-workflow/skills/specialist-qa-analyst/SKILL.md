...
| テンプレート | `share-artifacts/templates/qa-design.md`, `share-artifacts/templates/qa-flow.md`   |
| 書き方ガイド | `share-artifacts/references/qa-design.md`, `share-artifacts/references/qa-flow.md` |
...
- `share-artifacts/references/qa-design.md` (列定義 / 2 軸 enum / 業界 taxonomy 対応)
- `share-artifacts/references/qa-flow.md` (Mermaid flowchart 構文 / 分割指針 / skip 葉規約)
- `share-artifacts/templates/qa-design.md` (出力フォーマット雛形)
- `share-artifacts/templates/qa-flow.md` (出力フォーマット雛形)
...
| Mermaid flowchart が 30 ノード超で分割が必要               | 関心領域別に複数セクションへ分割 (`share-artifacts/references/qa-flow.md` 参照)    |
