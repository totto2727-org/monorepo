...
4. テンプレートパス 3 件
5. 書き方ガイド 3 件のパス
6. 既存の `docs/adr/` 配下 ADR 群 (本ロードマップが踏まえるべき横断規範)
...
- 「最終マイルストーン = 統合検証マイルストーン」を必要に応じて配置（intent-spec.md L97 方針）
