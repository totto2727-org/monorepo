...
| Skill                 | Purpose                                                                                                         |
| --------------------- | --------------------------------------------------------------------------------------------------------------- |
| `share-artifacts`     | 18 artifact specifications; references and templates with 1:1 pairing (three documented exceptions)             |
