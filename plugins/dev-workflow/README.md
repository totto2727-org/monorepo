...
A Main coordinator orchestrates nine specialist subagents (`intent-analyst`, `researcher`, `architect`, `planner`, `implementer`, `self-reviewer`, `reviewer`, `validator`, `retrospective-writer`) through a flat 9-step lifecycle:

1. Intent Clarification → 2. Research → 3. Design → 4. Task Decomposition → 5. Implementation → 6. Self-Review → 7. External Review → 8. Validation → 9. Retrospective
