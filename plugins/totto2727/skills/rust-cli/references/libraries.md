...
| レイヤ             | 用途                                | 推奨                     |
| ------------------ | ----------------------------------- | ------------------------ |
| L1: プロンプト     | select / input / confirm / password | `inquire`                |
| L1: 進捗・スピナー | プログレスバー / 待機表示           | `indicatif`              |
| L2: 宣言的 TUI     | React 風コンポーネント              | `iocraft`                |
| L3: 命令的 / Elm   | フル画面ダッシュボード              | `tui-realm` on `ratatui` |
