...
- **`git-workflow`** (external skill) — Conventional Commits, GPG signing, staging discipline, multi-branch PR splitting. Apply to every commit produced while implementing the conventions documented here.
