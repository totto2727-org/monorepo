...
For the current repository baseline, depend on `totto2727/admiral@0.3.0`. Keep the package name and version consistent in `moon.mod`, `moon.pkg`, and any generated compatibility manifest such as `package.nix`.
