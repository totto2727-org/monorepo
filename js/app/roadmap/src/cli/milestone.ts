...
import { milestoneSetCommand } from '#@/cli/milestone/set.ts'
...
export const milestoneCommand = Command.make('milestone').pipe(
  ...
  Command.withSubcommands([milestoneNewCommand, milestoneLsCommand, milestoneStatusCommand, milestoneSetCommand]),
)
