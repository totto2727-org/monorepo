...
| Web UI レンダリング戦略 (PageOrFrame)     | (未採用、Hello World は素 `c.render(<Document>...</Document>)`)       | ms-04 / ms-07 で本格 UI を作る際、`hono-remix-v3-cloudflare-example/app/ui/page-or-frame.tsx` の `createPageOrFrame` パターンへ移行 |
