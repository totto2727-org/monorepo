...
- **Last updated:** 2026-05-02T13:29:59Z
...
3. **入力プラグイン基盤** — 任意入力源を**コードレベルで後付け可能**にするプラグイン契約。HTML 解析 / RSS / X リストの取り込みを参照アダプタとして含む
4. **出力プラグイン基盤** — 任意出力先を**コードレベルで後付け可能**にするプラグイン契約。API / Slack / Web UI 配信を参照アダプタとして含む
