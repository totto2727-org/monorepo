...
defmodule Symphony.TestSupport do
    ...
    quote do
      ...
      setup do
        workflow_root =
          Path.join(
            System.tmp_dir!(),
            "symphony-workflow-#{System.unique_integer([:positive])}"
          )
  ...
  defp stop_supervised_http_server do
    case Enum.find(Supervisor.which_children(Symphony.Supervisor), fn
           {Symphony.HttpServer, _pid, _type, _modules} -> true
           _child -> false
         end) do
